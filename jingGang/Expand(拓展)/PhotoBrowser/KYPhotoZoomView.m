...
- (void)initView
{
    ...
    [_originButton setTitle:@"保存" forState:UIControlStateNormal];
...
//                        }];
    ...
    [YSImageConfig yy_view:_imageView setImageWithURL:[NSURL URLWithString:_photoModel.originURLString]
               placeholder:placeholderImage
                   options:kNilOptions
                  progress:^(NSInteger receivedSize, NSInteger expectedSize) {
...
//                             }];
        ...
        [YSImageConfig yy_view:_imageView setImageWithURL:[NSURL URLWithString:photoModel.originURLString] placeholder:placeholderImage options:kNilOptions progress:^(NSInteger receivedSize, NSInteger expectedSize) {
             _process = (CGFloat)receivedSize/(CGFloat)expectedSize;
...
//                              }];
        ...
        [YSImageConfig yy_view:_imageView setImageWithURL:[NSURL URLWithString:photoModel.thumbURLString]
                   placeholder:placeholderImage
                       options:kNilOptions
                      progress:^(NSInteger receivedSize, NSInteger expectedSize) {
