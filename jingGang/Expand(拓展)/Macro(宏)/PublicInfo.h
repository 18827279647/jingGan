...
#define kServiceShareUrlWithID(ID) [NSString stringWithFormat:@"%@/group/store.htm?id=%@",Shop_url,ID]
#define kMerchantShareWithID(ID) [NSString stringWithFormat:@"%@/group/view_%@.htm",Shop_url,ID]



#define kInvitationShareTitle1(integral) [NSString stringWithFormat:@"噢耶！我已轻松加入e生康缘，且获取%@积分！\
",integral]
...
#define k_ShareURL   @"http://static.bhesky.cn/person.html"

#define k_ShareDec  @"在e生康缘发现这个服务很不错哦！快来下载吧！http://static.bhesky.cn/static/platform/appDownload.jsp"
#define k_DownAppUrl @"http://static.bhesky.cn/static/platform/appDownload.jsp"
...
#define background_Color2 UIColorFromRGB(0xf7f7f7)
