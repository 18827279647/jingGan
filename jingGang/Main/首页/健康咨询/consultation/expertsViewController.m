...
//    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"home_title"] forBarMetrics:UIBarMetricsDefault];
    [YSThemeManager setNavigationTitle:@"专家" andViewController:self];
...
- (void)greatUI
{
    ...
    [YSImageConfig sd_view:head_img setimageWithURL:[NSURL URLWithString:self.img_str] placeholderImage:[UIImage imageNamed:@"per_defult_head"]];
...
//        [head_img sd_setImageWithURL:[NSURL URLWithString:img_str] placeholderImage:[UIImage imageNamed:@"per_defult_head"]];
        [YSImageConfig sd_view:head_img setimageWithURL:[NSURL URLWithString:img_str] placeholderImage:[UIImage imageNamed:@"per_defult_head"]];
