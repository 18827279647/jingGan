...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    KJGoodsDetailViewController *goodsDateilVC = [[KJGoodsDetailViewController alloc]init];
    goodsDateilVC.goodsID = (NSNumber *)dict[@"id"];
    [self.navigationController pushViewController:goodsDateilVC animated:YES];
}
...
- (void)loadCellContent:(UITableViewCell *)cell indexPath:(NSIndexPath *)indexPath
{
    ...
    [YSImageConfig yy_view:goodsCell.goodsLogo setImageWithURL:[NSURL URLWithString:dict[@"goodsMainPhotoPath"]] placeholderImage:DEFAULTIMG];
...
- (void)setUIContent
{
    ...
    [YSThemeManager setNavigationTitle:@"我收藏的商品" andViewController:self];
