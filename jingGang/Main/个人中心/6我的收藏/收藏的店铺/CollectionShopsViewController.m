...
- (void)loadCellContent:(UITableViewCell *)cell indexPath:(NSIndexPath *)indexPath
{
    ...
    [YSImageConfig yy_view:shopCell.shopLogo setImageWithURL:[NSURL URLWithString:dict[@"storeLogoPath"]]  placeholderImage:DEFAULTIMG];
...
- (void)setUIContent
{
    ...
    [YSThemeManager setNavigationTitle:@"我收藏的店铺" andViewController:self];
