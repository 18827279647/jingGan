...
//    self.certainBtn.backgroundColor = [YSThemeManager buttonBgColor];    
...
- (IBAction)shezhi:(UISwitch *)sender {
    if(sender.isOn){
        NSLog(@"开关");
    }else{
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [YSThemeManager setNavigationTitle:@"管理收货地址" andViewController:self];
