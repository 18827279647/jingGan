...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    label.textColor = COMMONTOPICCOLOR;
...
- (void)initUI
{
    switch (self.type) {
        case kAddMERType:
        {
            ...
            [YSThemeManager setNavigationTitle:@"新增体检报告" andViewController:self];
        }
            break;
        case kEditMERType:
        {
            [self.saveBtn setTitle:@"保存" forState:UIControlStateNormal];
            [YSThemeManager setNavigationTitle:@"编辑体检报告" andViewController:self];
        }
            break;
        default:
            break;
...
//    [self.saveBtn setBackgroundColor:[YSThemeManager buttonBgColor]];
}
