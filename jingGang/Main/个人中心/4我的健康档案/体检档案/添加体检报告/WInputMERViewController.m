...
- (void)initUI
{
//    self.saveButton.backgroundColor = [YSThemeManager buttonBgColor];
    ...
    [YSThemeManager setNavigationTitle:[NSString stringWithFormat:@"%@年%@月%@日体检报告",dateArray[0],dateArray[1],dateArray[2]] andViewController:self];
