...
@property (weak, nonatomic) IBOutlet UIButton *shareSettingButton;
...
- (void)_init {
    ...
    self.shareContentEditTextView.text = self.shareTitle;
    [YSThemeManager setNavigationTitle:@"邀请设置" andViewController:self];
//    self.shareSettingButton.backgroundColor = [YSThemeManager buttonBgColor];
}
