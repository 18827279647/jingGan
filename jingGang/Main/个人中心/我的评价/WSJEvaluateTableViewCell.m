...
- (void)willCellWithModel:(WSJEvaluateModel *)model
{
    ...
    if (model.isMeEvaluate)
    {
        ...
        view2.hidden = NO;
        y = y + 20;
        [YSImageConfig yy_view:self.titleImage2 setImageWithURL:[NSURL URLWithString:model.titleImageURL] placeholderImage:DEFAULTIMG];
    ...
    else
    {
        view1.hidden = NO;
        view2.hidden = YES;
        [YSImageConfig yy_view:self.titleImage setImageWithURL:[NSURL URLWithString:model.titleImageURL] placeholderImage:DEFAULTIMG];
...
- (NSURL *)photoBrowser:(SDPhotoBrowser *)browser highQualityImageURLForIndex:(NSInteger)index
{
    ...
    return [NSURL URLWithString:_saveModel.dataImageArray[index]];
}
