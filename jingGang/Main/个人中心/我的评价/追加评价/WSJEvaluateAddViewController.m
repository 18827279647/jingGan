...
- (void) initUI
{
    ...
    certainBtn.backgroundColor = [YSThemeManager buttonBgColor];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [YSThemeManager setNavigationTitle:@"追加评论" andViewController:self];
}
//创建商品头部，第一层
- (UIView *) createShoppView
{
    ...
    [YSImageConfig yy_view:img setImageWithURL:[NSURL URLWithString:self.model.titleImageURL] placeholderImage:DEFAULTIMG];
    [v addSubview:img];
