...
-(void)startMarqueeViewAnimation{
    ...
    [self.customView1.ImageView sd_setImageWithURL:[NSURL URLWithString:self.marqueeTitleArray[currentIndex]]];
    ...
    [self.customView2.ImageView sd_setImageWithURL:[NSURL URLWithString:self.marqueeTitleArray[currentIndex]]];
