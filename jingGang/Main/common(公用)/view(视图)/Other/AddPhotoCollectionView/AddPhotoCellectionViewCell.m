...
@interface AddPhotoCellectionViewCell ()
...
- (void)awakeFromNib {
    ...
    self.deleteButton.backgroundColor = [color colorWithAlphaComponent:0.3];
    self.photoBgView.layer.cornerRadius = 6.0;
    self.photoBgView.clipsToBounds = YES;
}
