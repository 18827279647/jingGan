...
#pragma mark - 修改
    [YSThemeManager setNavigationTitle:_name_str andViewController:self];
        ...
        if (indexPath.section == 0) {
            ...
            if (dataArray && dataArray.count > 0 && dataArray.count > indexPath.row) {
                ...
                if (indexPath.row%2 == 1) {
                    ...
                    [YSImageConfig yy_view:cell.left_img setImageWithURL:[NSURL URLWithString:url] placeholderImage:nil];
                }else{
                    ...
                    [YSImageConfig yy_view:cell.right_img setImageWithURL:[NSURL URLWithString:url] placeholderImage:nil];
                }
...
//                cell = [array objectAtIndex:0];
            ...
            if (secondDataArray && secondDataArray.count > 0 && indexPath.row < secondDataArray.count) {
                ...
                [YSImageConfig yy_view:cell.left_img setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@_160x150",bo.adImgPath]] placeholderImage:nil];
            }
            return cell;
        }
    }
        ...
        if (indexPath.section == 0) {
            ...
            if (secondDataArray && secondDataArray.count > 0) {
                ...
                cell.name_lab.text = bo.adTitle;
                cell.sub_lab.text = bo.adText;
                [YSImageConfig yy_view:cell.left_img setImageWithURL:[NSURL URLWithString:bo.adImgPath] placeholderImage:nil];
            }
...
-(void)_requestAdDataWithCode:(NSString *)addCode{
    ...
    [vapManage snsRecommendList:request success:^(AFHTTPRequestOperation *operation, SnsRecommendListResponse *response) {
        ...
        if ([addCode isEqualToString:Kongqi_shouye_xiangguan_zixun]
            ...
            [YSImageConfig yy_view:lit_img_view setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@_720x124",img_str]] placeholderImage:[UIImage imageNamed:@"yunAd"]];
