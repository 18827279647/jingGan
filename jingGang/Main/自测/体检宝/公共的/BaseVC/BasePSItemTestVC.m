...
-(void)_initNavView{
    ...
    [YSThemeManager setNavigationTitle:_navTitle andViewController:self];
...
- (void)_initTopTabar {
    ...
    _topBarHMSegmentedControl.selectionIndicatorColor = COMMONTOPICCOLOR;
    _topBarHMSegmentedControl.selectedTextColor = COMMONTOPICCOLOR;
