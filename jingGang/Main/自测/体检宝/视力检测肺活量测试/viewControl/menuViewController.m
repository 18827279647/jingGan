...
- (void) initMenuUI
{
    ...
    [_menuContentArray enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
        ...
        [btn setTitleColor:[YSThemeManager buttonBgColor] forState:UIControlStateSelected];
    ...
    _menuLowBack = [[UIView alloc] initWithFrame:CGRectMake(0, _menuView.frame.size.height - 2, __MainScreen_Width / _menuContentArray.count, 2)];
    _menuLowBack.backgroundColor = [YSThemeManager buttonBgColor];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [YSThemeManager setNavigationTitle:self.titleText andViewController:self];
}
