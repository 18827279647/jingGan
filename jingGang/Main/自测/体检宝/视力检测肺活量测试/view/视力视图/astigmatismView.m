...
//第二层
    ...
    warnningImageView.x = 18;
    warnningImageView.y = (label1.height - warnningImageView.height) / 2;
    [label1 addSubview:warnningImageView];
    ...
    [_btnN setImage:[UIImage imageNamed:@"ys_healthymanage_icon_normal"] forState:UIControlStateNormal];
    [_btnN setImage:[UIImage imageNamed:@"ys_healthymanage_icon_selected"] forState:UIControlStateSelected];
    [_btnN addTarget:self action:@selector(selectBtn:) forControlEvents:UIControlEventTouchUpInside];
    _btnN.bounds = CGRectMake(0, 0, 18, 18);
    ...
    [_btnS setImage:[UIImage imageNamed:@"ys_healthymanage_icon_normal"] forState:UIControlStateNormal];
    [_btnS setImage:[UIImage imageNamed:@"ys_healthymanage_icon_selected"] forState:UIControlStateSelected];
...
//第三层
    ...
    backView3.backgroundColor = JGWhiteColor;
    ...
    submit.bounds = CGRectMake(0, 0, ScreenWidth - 57, 44);
    submit.layer.cornerRadius = 5;
    submit.backgroundColor = COMMONTOPICCOLOR;
    submit.titleLabel.font = JGFont(17);
