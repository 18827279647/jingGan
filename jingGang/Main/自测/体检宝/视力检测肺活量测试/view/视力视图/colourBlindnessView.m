...
//第三层  滚筒
    ...
    centerView.backgroundColor = JGClearColor;
    centerView.bounds = CGRectMake(0, 0, ScreenWidth + 4, 30);
    centerView.layer.borderWidth = 0.75;
    centerView.layer.borderColor = [[UIColor lightGrayColor] colorWithAlphaComponent:0.36].CGColor;
...
//第四层 按钮
    ...
    backView3.backgroundColor = JGBaseColor;
    ...
    fuzzy.layer.borderColor = COMMONTOPICCOLOR.CGColor;
    [fuzzy setTitle:@"看不清楚" forState:UIControlStateNormal];
    [fuzzy setTitleColor:COMMONTOPICCOLOR forState:UIControlStateNormal];
    fuzzy.layer.cornerRadius = 16.0f;
    fuzzy.clipsToBounds = YES;
    fuzzy.center = CGPointMake(__MainScreen_Width / 7 * 2, backView3.frame.size.height / 2);
    fuzzy.bounds = CGRectMake(0, 0, 100, 36);
    fuzzy.tag = 0;
    ...
    certain.tag = 1;
    certain.backgroundColor = COMMONTOPICCOLOR;
    ...
    certain.bounds = CGRectMake(0, 0, 100, 36);
    certain.layer.cornerRadius = 16;
    certain.clipsToBounds = YES;
...
- (UIView *)selector:(IZValueSelectorView *)valueSelector viewForRowAtIndex:(NSInteger)index {
    ...
    label.backgroundColor = JGClearColor;
    return label;
}
