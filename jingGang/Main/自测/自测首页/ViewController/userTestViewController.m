...
//            [cell.left_img sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@_%ix%i",model.adImgPath,(int)cell.left_img.frame.size.width*2,(int)cell.left_img.frame.size.height*2]] placeholderImage:[UIImage imageNamed:@"background"]];
            [YSImageConfig yy_view:cell.left_img setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@_%ix%i",model.adImgPath,(int)cell.left_img.frame.size.width*2,(int)cell.left_img.frame.size.height*2]] placeholderImage:[UIImage imageNamed:@"background"]];
...
-(void)_freswNesCellForbidden{
    ...
    for (int i=0; i<cellArr.count; i++) {
        ...
        [YSImageConfig yy_view:cell._left_img setImageWithURL:[NSURL URLWithString:model.adImgPath] placeholderImage:nil];
