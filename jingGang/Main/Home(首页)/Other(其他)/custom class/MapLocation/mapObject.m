...
+(id)sharedMap
{
    ...
    if (!mapModel.baiduLatitude || !mapModel.baiduLongitude) {
        mapModel.baiduLongitude = [NSNumber numberWithFloat:[YSLocationManager sharedInstance].coordinate.longitude];
        mapModel.baiduLatitude = [NSNumber numberWithFloat:[YSLocationManager sharedInstance].coordinate.latitude];
    }
    return mapModel;
}
