...
- (void)viewDidLoad {
    ...
    self.arr_trf = [NSMutableDictionary dictionaryWithDictionary:[[NSUserDefaults standardUserDefaults]objectForKey:kUserCustomerKey]];
...
-(void)creatUIBtn
{
    NSArray * top_btn_name = [NSArray arrayWithObjects:@"用户资料",@"修改密码", @"修改健康豆密码",nil];
    ...
    self.slideSegmentController.indicator.backgroundColor = COMMONTOPICCOLOR;
