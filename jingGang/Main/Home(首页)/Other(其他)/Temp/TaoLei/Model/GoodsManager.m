...
//        self.goodsCurrentPrice = goodsCart[@"goods"][@"goodsShowPrice"];
        ...
        self.needYgb = goodsCart[@"goods"][@"needYgb"];
        self.needMoney = goodsCart[@"goods"][@"needMoney"];
        self.needIntegral = [NSString stringWithFormat:@"%@",goodsCart[@"goods"][@"needIntegral"]];
//        self.hasMobilePrice = (Boolean)goodsCart[@"goods"][@"hasMobilePrice"];
        ...
        self.pdPrice = goodsCart[@"goods"][@"pdPrice"];
        NSLog(@"pdPricepdPrice%@",self.pdPrice);
