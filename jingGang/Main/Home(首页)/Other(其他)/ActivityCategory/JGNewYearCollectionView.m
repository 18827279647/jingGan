...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    if (kind == UICollectionElementKindSectionHeader) {
        ...
        [YSImageConfig sd_view:headimg setimageWithURL:[NSURL URLWithString:self.apiBO.headImage] placeholderImage:nil];
        return reusableView;
    }else {
        ...
        [YSImageConfig sd_view:footimg setimageWithURL:[NSURL URLWithString:self.apiBO.footImage] placeholderImage:nil];
        return reusableView;
    }
}
