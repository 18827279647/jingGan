...
- (void) requestData
{
    ...
    [_vapiManager shopStoreInfoGet:infoRequest  success:^(AFHTTPRequestOperation *operation, ShopStoreInfoGetResponse *response) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSString *strStoreLogoUrl = [YSThumbnailManager shopStoreDetailStoreLogoPicUrlString:dict[@"storeLogoPath"]];
            [YSImageConfig yy_view:self.titleImageView setImageWithURL:[NSURL URLWithString:strStoreLogoUrl] placeholderImage:DEFAULTIMG];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [YSThemeManager setNavigationTitle:@"店铺" andViewController:self];
