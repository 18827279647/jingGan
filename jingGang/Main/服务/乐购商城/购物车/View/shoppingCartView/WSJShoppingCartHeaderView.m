...
- (IBAction)selectBtn:(UIButton *)sender {
    ...
    if (self.selectBlock)
    {
        self.selectBlock(sender.selected,self.indexPathSection);
    }
}
-(void)awakeFromNib
{
    [super awakeFromNib];
    [self.editBtn setTitleColor:[YSThemeManager buttonBgColor] forState:UIControlStateSelected];
...
- (void)setIndexPathSection:(NSInteger)indexPathSection{
    _indexPathSection = indexPathSection;
}
//编辑按钮
