...
//         headimg.image = [UIImage imageNamed:@"christmas_header"];  
         [YSImageConfig sd_view:headimg setImageWithURL:[NSURL URLWithString:self.activityApiBO.headImage] placeholderImage:[UIImage imageNamed:@"christmas_header"] options:SDWebImageRefreshCached progress:^(NSInteger receivedSize, NSInteger expectedSize) {
