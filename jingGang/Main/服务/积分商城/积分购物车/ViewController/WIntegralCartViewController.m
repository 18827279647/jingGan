...
- (void)calculateResultIntegralWithNeed:(NSInteger)need
{
    ...
    NSDictionary *attributDict = [NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:15.0],NSFontAttributeName,[YSThemeManager buttonBgColor],NSForegroundColorAttributeName, nil];
