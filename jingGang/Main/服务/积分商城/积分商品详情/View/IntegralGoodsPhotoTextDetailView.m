...
@property (weak, nonatomic) IBOutlet UILabel *ptPhotoDetailTitel;
...
-(void)awakeFromNib{
    ...
    [self _initInfo];
    self.ptPhotoDetailTitel.textColor = [YSThemeManager buttonBgColor];
    self.bottomView.backgroundColor = [YSThemeManager buttonBgColor];
}
