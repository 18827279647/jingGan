...
//    [Util setTitleViewWithTitle:@"商户环境图片" andNav:self.navigationController];
    [YSThemeManager setNavigationTitle:@"商户环境" andViewController:self];
}
...
//    cell.titleName.text = @"";
    [YSImageConfig sd_view:cell.environmentImg setimageWithURL:[NSURL URLWithString:contentDic[@"path"]] placeholderImage:DEFAULTIMG];
