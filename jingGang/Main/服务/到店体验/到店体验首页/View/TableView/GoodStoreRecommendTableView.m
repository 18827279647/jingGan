...
-(void)_comfigureCell:(GoodStoreRecommendCell *)cell withModel:(PStoreInfoModel *)model {
    NSString *twiceImgUrl = model.photoPath;
    [YSImageConfig sd_view:cell.storeImgView setimageWithURL:[NSURL URLWithString:twiceImgUrl] placeholderImage:DEFAULTIMG];
