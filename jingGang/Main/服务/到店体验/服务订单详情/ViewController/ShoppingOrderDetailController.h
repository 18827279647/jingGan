...
@property (nonatomic,assign) ComeFromPushType comeFromePushType;

@property (assign, nonatomic) BOOL showRefundRefuseAlert;

@property (copy , nonatomic) NSString *refuseReasonString;
