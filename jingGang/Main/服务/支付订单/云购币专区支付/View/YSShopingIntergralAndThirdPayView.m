//
//  YSShopingIntergralAndThirdPayView.m
//  jingGang
//
...
@interface YSShopingIntergralAndThirdPayView ()<UITextFieldDelegate>
@property (nonatomic,strong) UIButton *selectedBtn;

@property (nonatomic,strong) YSYgbPayModel *ygbPayModel;
@end

@implementation YSShopingIntergralAndThirdPayView
...
- (void)initThirdPartyPayView{
    ...
    UIView *thirdPartyPayBgView = [[UIView alloc]initWithFrame:CGRectMake(0, viewY, kScreenWidth, 173)];
    ...
    UILabel *labelPayableCash = [[UILabel alloc]initWithFrame:CGRectMake(kScreenWidth - payableCashSize.width - 18, 0, payableCashSize.width, 16)];
...
- (void)initYunGouBiView{
    ...
    //云购币余额label
    NSString *strYunGouBiBalance = [NSString stringWithFormat:@"购物积分支付 (余额为：%.0f)",[self.ygbPayModel.currentIntegralBalance floatValue]];
    ...
    labelYunGouBiPayable.font = [UIFont systemFontOfSize:14.0];
