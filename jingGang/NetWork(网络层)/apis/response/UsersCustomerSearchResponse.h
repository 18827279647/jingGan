...
//预分润健康豆
@property (nonatomic, readonly, copy) NSNumber *recordBalance;
//用户财富
...
//第一级别人数
@property (nonatomic, readonly, copy) NSNumber *levelOneCount;
//第二级别人数
@property (nonatomic, readonly, copy) NSNumber *levelTwoCount;
//第三级别人数
@property (nonatomic, readonly, copy) NSNumber *levelThreeCount;
//CN账户的奖金
@property (nonatomic, readonly, copy) NSNumber *cNBonus;
//CN账户的云购币(冲销币)
@property (nonatomic, readonly, copy) NSNumber *cNRepeat;
//用户总健康豆
@property (nonatomic, readonly, copy) NSString *countMoney;
//充值账户余额
@property (nonatomic, readonly, copy) NSNumber *cNrecharge;
//CN会员购物积分
@property (nonatomic, readonly, copy) NSNumber *cnIntegral;

@property (nonatomic, readonly, copy) NSNumber *userType;
