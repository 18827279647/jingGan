...
+(NSDictionary *) JSONKeyPathsByPropertyKey {
    return @{
			...
			@"shopCartSize":@"shopCartSize",
             @"jingxuanCartList":@"jingxuanCartList",
             @"jingxuanCartList":@"jingxuanCartList",

             @"spikeCanBuyCartList":@"spikeCanBuyCartList",
             @"spikeNotCanBuyCartList":@"spikeNotCanBuyCartList",


             
             @"jingxuanCartListSize":@"jingxuanCartListSize",
             };
}
...
+(NSValueTransformer *) jingxuanCartListTransformer
{
    return [NSValueTransformer mtl_JSONDictionaryTransformerWithModelClass:[ShopGoodsCart class]];
}
