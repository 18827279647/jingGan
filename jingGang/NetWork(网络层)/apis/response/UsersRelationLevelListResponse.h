...
@interface UsersRelationLevelListResponse :  AbstractResponse
//用户信息 
...
//第一级别人数
@property (nonatomic, copy) NSNumber *levelOneCount;
//第二级别人数
@property (nonatomic, copy) NSNumber *levelTwoCount;
//第三级别人数
@property (nonatomic, copy) NSNumber *levelThreeCount;
@end
