                       ...
                       failure:(void (^)(AFHTTPRequestOperation *operation,NSError *error))failure
{
    [self setAccessTokenHeader: request.accessToken];
    //版本号
    [self.requestSerializer setValue:CRAppVersionShort forHTTPHeaderField:@"user-agent2"];
    self.responseSerializer = [SCLMantleResponseSerializer serializerForModelClass:request.responseClazz];
    [self POST:request.getUrl parameters:request.getQueryParameters success:success failure:failure];
}
...
-(void) postPagePostList:(PostPagePostListRequest *) request
...
-(void) postPostUpdatePraiseNum:(PostPostUpdatePraiseNumRequest *) request
...
-(void) postPostPostsave:(PostPostPostsaveRequest *) request
...
-(void) postPushLabelList:(PostPushLabelListRequest *) request
...
-(void) postPostCanclePraise:(PostPostCanclePraiseRequest *) request
...
-(void) postPagePostListByUserId:(PostPagePostListByUserIdRequest *) request
...
-(void) postPagePostListBylabelId:(PostPagePostListBylabelIdRequest *) request
...
-(void) postIsLogin:(PostIsLoginRequest *) request
...
-(void) postPostListLogin:(PostPostListLoginRequest *) request
                  success:(void (^)(AFHTTPRequestOperation *operation,PostPostListLoginResponse *response))success
                  failure:(void (^)(AFHTTPRequestOperation *operation,NSError *error))failure
{
    [self setAccessTokenHeader: request.accessToken];
    self.responseSerializer = [SCLMantleResponseSerializer serializerForModelClass:request.responseClazz];
//    [self.responseSerializer.acceptableContentTypes = [NSSet setWithObject:@"text/html"]; addAcceptableContentTypes:[NSSet setWithObject:@"text/plain"]];
...
-(void) postPagePostlistLogin:(PostPagePostlistLoginRequest *) request
...
-(void) healthManageIndex:(HealthManageIndexRequest *) request
...
-(void) usersRelationLevelList:(UsersRelationLevelListRequest *) request
...
-(void) healthManageIndex2:(HealthManageIndex2Request *) request
...
-(void) postPostListMuid:(PostPostListMuidRequest *) request
...
-(void) postPostDelete:(PostPostDeleteRequest *) request
...
-(void) postPostDetail:(PostPostDetailRequest *) request
...
-(void) postPostEvaluete:(PostPostEvalueteRequest *) request
...
-(void) postPostReply:(PostPostReplyRequest *) request
...
-(void) appleChecked:(AppleCheckedRequest *) request
...
-(void) bindingCreatUser:(BindingCreatUserRequest *) request
...
-(void) usersYunGouMoneyList:(UsersYunGouMoneyListRequest *) request
...
-(void) bindingMobileCheck:(BindingMobileCheckRequest *) request
...
-(void) usersCnBindMobile:(UsersCnBindMobileRequest *) request
...
-(void) usersCnIsBind:(UsersCnIsBindRequest *) request
...
-(void) usersMobileGoBind:(UsersMobileGoBindRequest *) request
...
-(void) usersMobileIsBind:(UsersMobileIsBindRequest *) request
...
-(void) usersCnmobileIsbind:(UsersCnmobileIsbindRequest *) request
...
-(void) usersCnmobileGobind:(UsersCnmobileGobindRequest *) request
...
-(void) cnuserBind:(CnuserBindRequest *) request
...
-(void) cnuserMobile:(CnuserMobileRequest *) request
...
-(void) usersGetBonusAndRepeat:(UsersGetBonusAndRepeatRequest *) request
...
-(void) bindingWeiXin:(BindingWeiXinRequest *) request
...
-(void) wxBindingCheck:(WxBindingCheckRequest *) request
...
-(void) codeSendIfMobile:(CodeSendIfMobileRequest *) request
...
-(void) bindingThird:(BindingThirdRequest *) request
...
-(void) userMessageList:(UserMessageListRequest *) request
...
-(void) userMessageDetail:(UserMessageDetailRequest *) request
...
-(void) bindingCnWx:(BindingCnWxRequest *) request
...
-(void) mobileBindingCheck:(MobileBindingCheckRequest *) request
...
-(void) integralFlipCards:(IntegralFlipCardsRequest *) request
...
-(void) integralFlipCardsGet:(IntegralFlipCardsGetRequest *) request
...
-(void) integralFlipCardsLost:(IntegralFlipCardsLostRequest *) request
...
-(void) versionControlGetNew:(VersionControlGetNewRequest *) request
...
-(void) countUserRegisterCount:(CountUserRegisterCountRequest *) request
...
-(void) personalHotCityList:(PersonalHotCityListRequest *) request
...
-(void) goodsGetOrderIsBought:(GoodsGetOrderIsBoughtRequest *) request
...
-(void) yunGougoodsList:(YunGougoodsListRequest *) request
...
-(void) passwordForgetToSourceUpdate:(PasswordForgetToSourceUpdateRequest *) request
...
-(void) shopTradeYgPaymet:(ShopTradeYgPaymetRequest *) request
...
-(void) personalGroupOrderAll:(PersonalGroupOrderAllRequest *) request
...
-(void) chunyuAccountSyn:(ChunyuAccountSynRequest *) request
...
-(void) shopTradeCxPaymet:(ShopTradeCxPaymetRequest *) request
...
-(void) shopTradeIntegralPaymet:(ShopTradeIntegralPaymetRequest *) request
...
-(void) goodsClassListAll:(GoodsClassListAllRequest *) request
...
-(void) shopJuanpiShare:(ShopJuanpiShareRequest *) request
