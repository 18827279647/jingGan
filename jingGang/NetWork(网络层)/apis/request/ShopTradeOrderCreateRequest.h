 ...
 * 支付方式 1 重消 2积分 0其他
 */
@property (nonatomic, readwrite, copy) NSNumber *api_payTypeFlag;


//是否为拼单商品
@property (nonatomic, readwrite, copy) NSNumber *api_payTogether;
...
//红包
@property (nonatomic, readwrite, copy) NSString * redPackageIds;
