...
@implementation ShopTradeIntegralPaymetRequest
...
{
    return ShopTradeIntegralPaymetResponse.class;
}

- (NSString *) getApiUrl
{
     NSString *url = [NSString stringWithFormat:@"%@/v1/shop/trade/integral/paymet",self.baseUrl];
    return url;
}
