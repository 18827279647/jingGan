...
- (NSMutableDictionary *) getQueryParameters
{
	...
	[self.queryParameters setValue:[self.api_payTypeFlag stringValue] forKey:@"payTypeFlag"];
    [self.queryParameters setValue:[self.api_payTogether stringValue] forKey:@"is_payTogethe"];
    [self.queryParameters setValue:self.api_orderId  forKey:@"pinDanLeaderOrderId"];
    [self.queryParameters setValue:self.redPackageIds  forKey:@"redPackageIds"];
