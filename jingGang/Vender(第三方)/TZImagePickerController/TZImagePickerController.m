...
//    self.oKButtonTitleColorNormal   = [[YSThemeManager themeColor] colorWithAlphaComponent:1];
//    self.oKButtonTitleColorDisabled =  [[YSThemeManager themeColor] colorWithAlphaComponent:.5];
//    
    if (iOS7Later) {
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (self.childViewControllers.count > 0) {
        ...
        [backButton setImage:[YSThemeManager getNavgationBackButtonImage] forState:UIControlStateNormal];
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    [YSThemeManager setNavigationTitle:@"照片" andViewController:self];
