...
typedef void(^PYDidSearchBlock)(PYSearchViewController *searchViewController, UISearchBar *searchBar, NSString *searchText,BOOL didSelectSuggestCell,NSDictionary *selectedSuggestDict); // 开始搜索时调用的block
...
@property (nonatomic, copy) NSArray<NSDictionary *> *searchSuggestions;
/** 搜索建议是否隐藏 默认为：NO */
