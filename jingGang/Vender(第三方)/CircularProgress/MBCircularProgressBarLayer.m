...
- (void) drawInContext:(CGContextRef) context{
    ...
    [self drawBgBar:rect context:context];
...
- (void)drawBgBar:(CGRect)rect context:(CGContextRef)c {
    ...
    CGPathAddArc(arc, NULL,
                 ...
                 (self.progressAngle/100.f)*M_PI-((-self.progressRotationAngle/100.f)*2.f+0.5)*M_PI-(2.f*M_PI)*(self.progressAngle/100.f)*(100.f-100.f*100/self.maxValue)/100.f,
    ...
    CGContextSetFillColorWithColor(c, [[UIColor whiteColor] colorWithAlphaComponent:0.38].CGColor);
