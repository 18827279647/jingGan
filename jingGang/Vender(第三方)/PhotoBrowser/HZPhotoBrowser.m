...
- (void)showFirstImage
{
    ...
    if ([sourceView isKindOfClass:[UIImageView class]]) {
        ...
        tempView.image = view.imageview.image;
    }else {
...
//    CGFloat placeImageSizeW = ScreenWidth;
//    CGFloat placeImageSizeH = ScreenHeight;
    CGRect targetTemp;
    ...
    targetTemp = CGRectMake(0, 0, kAPPWidth, KAppHeight);
    //先隐藏scrollview
    _scrollView.hidden = YES;
    _indexLabel.hidden = YES;
    _saveButton.hidden = YES;
    
    [UIView animateWithDuration:HZPhotoBrowserShowImageAnimationDuration delay:0.1 options:UIViewAnimationOptionCurveEaseIn animations:^{
